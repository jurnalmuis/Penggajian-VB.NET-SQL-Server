...
Public Class LapGajiPerKar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pengganjian.LapGajiPerKar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapGajiPerKar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapGajiPerKar = New LapGajiPerKar()
        rpt.Site = Me.Site
        Return rpt
    End Function
