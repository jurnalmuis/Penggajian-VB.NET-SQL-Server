...
Public Class LapLemburPerKar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pengganjian.LapLemburPerKar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapLemburPerKar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapLemburPerKar = New LapLemburPerKar()
        rpt.Site = Me.Site
        Return rpt
    End Function
